...
body {
            background-image: url("https://sneakernews.com/wp-content/uploads/2013/09/phantom-lagoons-asics-bait-2.jpg");
         }
</style>
</head>
<body style="background-color: #6CC5E0;">
<jsp:include page="/components/header1.jsp" ></jsp:include>
	...
	<div class="col-6" >
		...
		<form action="loginaction" method="post">
			...
			<p class="text-danger"><c:out value="${error}"/></p>
			 ...
			 <div class="text-center mx-3 my-3"><button type="submit" class="btn btn-secondary">Submit</button></div>
	...
	<div class="col-6">
		<div class="contain p-3 my-3 bg-white text-black">
